...
> Job admin_apply_model_async(token, application_id, model_id, document_ids, body=body, tag=tag, format_type=format_type, execute_after_id=execute_after_id, page_range=page_range, callback_url=callback_url, model_params=model_params)
...
try:
    # Asynchronously applies a model on documents (admin only)
    api_response = api_instance.admin_apply_model_async(token, application_id, model_id, document_ids, body=body, tag=tag, format_type=format_type, execute_after_id=execute_after_id, page_range=page_range, callback_url=callback_url, model_params=model_params)
    pprint(api_response)
